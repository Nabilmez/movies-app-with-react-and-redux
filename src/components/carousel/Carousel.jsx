...
import ImgLoad from "../LazyLoadImage/ImgLoad";
        ...
        {!loading ? (
          <div ref={carouselContainer} className="carouselItems">
            {data?.map(item=>{
              ...
              PosterFallback;
              const itemRating = item.vote_average.toFixed(1)
              return (
                <div
                key={item.id}
                ...
                >
                  <div className="posterBlock">
                    <ImgLoad className='lazy-load-image-background' src={posterUrl} />
                    <CircleRating rating={itemRating} />
